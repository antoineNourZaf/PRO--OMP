...
public class FileSystemOpen{
    ...
    public String run() throws Exception{
        ...
        try{
            ...
            fenetreDialogue.getExtensionFilters().addAll(new FileChooser.ExtensionFilter("Audio Files","*.aiff","*.m4a", "*.mp3","*.wav"));
            fenetreDialogue.getExtensionFilters().addAll(new FileChooser.ExtensionFilter("Video Files", "*.mp4","*.flv","*.fxm"));
            fenetreDialogue.getExtensionFilters().addAll(new FileChooser.ExtensionFilter("Supported Files", "*.mp3","*.aiff","*.wav","*.mp4","*.flv","*.m4a","*.fxm"));
