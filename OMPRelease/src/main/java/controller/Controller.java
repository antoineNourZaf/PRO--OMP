      ...
      if (audio == null) {
         ...
         for (int i = 0; i < audio.size(); i++) {
            ...
            if (format.getTextContent().equals("mp3") || format.getTextContent().equals("aac")
                    || format.getTextContent().equals("m4a") || format.getTextContent().equals("wav")) {
               typeMedia = "audio";
   ...
   public void tableViewCliqued(MouseEvent click) {
      ...
      if (click.getClickCount() == 2 && tableView.getSelectionModel().getSelectedItem() != tableView.getColumns().get(0)) {
         ...
         try {
            ...
            final MediaPlayerViewController controller = loader.getController();
            ...
            //Pour arreter les medias lorsqu'on ferme la fenetre
