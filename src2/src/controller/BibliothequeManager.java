...
public class BibliothequeManager extends Observable {
   ...
   public BibliothequeManager() {
      ...
      FICHIER_XML = new File("C:\\Users\\Antoine\\Documents\\2eme\\S4\\PRO\\PRO_OMP\\src\\model\\bibliotheque.xml");
    ...
    */
   public void createBibliotheque() throws TransformerConfigurationException, TransformerException {
   ...
   public void  ajouterMusique(Audio chanson) {
      ...
      try {
         ...
         cheminAcces.setTextContent(chanson.getPath());

         Element artiste = doc.createElement("Artiste");
         artiste.setTextContent(chanson.getArtiste());
         Element titre = doc.createElement("Titre");
         titre.setTextContent(chanson.getTitre());

         Element album = doc.createElement("Album");
         album.setTextContent(chanson.getAlbum());

         Element duree = doc.createElement("Duree");
         duree.setTextContent(chanson.getDuree());

         Element format = doc.createElement("Format");
         format.setTextContent(chanson.getFormat());
   ...
   /**
    * Supprime une musique ou une video du XML;
    * 
    * @param path Le chemin de la musique a supprimer 
    */
   public void supprimerFichier(String path) {
      ...
      try {
         ...
         NodeList pathList = doc.getElementsByTagName("Chemin");
         int length = pathList.getLength();
         
         for (int i = 0; i < length; ++i) {
            
            Node chemin = pathList.item(i);
   ...
   public void creerPlaylist(String name) {
      ...
      try {
         ...
         // Insertion du titre
         Element titreP = doc.createElement("Name");
   ...
   public void addToPlaylist(String titrePlaylist, String path) {
      ...
      try {
         ...
         NodeList titrePList = doc.getElementsByTagName("Name");
   ...
   public String getId(String path) {
      ...
      try {
         ...
         Logger.getLogger(BibliothequeManager.class.getName()).log(Level.SEVERE, null, e);
      }
   ...
   public void deletePlaylist(String nomPlaylist) {
      ...
      try {
         ...
         NodeList listeTitreP = doc.getElementsByTagName("Name");
   ...
   public void ajouterVideo(Video clip) {
      try {
         ...
         // Si le noeud <Videos> a des elements <Video> , on verifie que la 
         // video existe déja dans le fichier xml, auquel cas on la supprime 
         ...
         Element cheminAcces = doc.createElement("Chemin");
         cheminAcces.setTextContent(clip.getPath());

         Element titre = doc.createElement("Titre");
         titre.setTextContent(clip.getTitre());

         Element duree = doc.createElement("Duree");
         duree.setTextContent(clip.getDuree());

         Element format = doc.createElement("Format");
         format.setTextContent(clip.getFormat());
