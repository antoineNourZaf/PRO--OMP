...
public class ParserXML {
   ...
   public ParserXML() {
      ...
      try {
	     ...
	     *  création d'un Document
          */
         final Document document = builder.parse(new File("C:\\Users\\Antoine\\Documents\\2eme\\S4\\PRO\\PRO_OMP\\src\\model\\bibliotheque.xml"));
   ...
   public ArrayList<Element> mesAudios(NodeList nodeaudios) {
      ...
      for (int j = 0; j < nbaudiosElements; j++) {
         ...
         final Element chemin = (Element) audio.getElementsByTagName("Chemin").item(0);
